...
class GridOptimizer:
    ...
    def calculate_cost_to_go_matrix_sequence(self, depth):
        ...
        Sets(attributes):
            self.max_iter_depth(int): new depth
            self.max_cost_to_go_m: calculated cost to go matrix for this depth
            self.max_opt_dec_m: calculated optimal decision for this depth
        """
